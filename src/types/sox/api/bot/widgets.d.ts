...
declare namespace bot {
    ...
    interface widgets {
         ...
         * @param param0 The first parameter for the interaction
         * @param param1 The second parameter for the interaction (optional)
         */
        interactSpecifiedWidget: (packedWidgetId: number, identifier: number, opcode: number, param0: number, param1?: number) => void;
