...
declare namespace net.runelite.client.ui.overlay {
	export class OverlayUtil {
		...
		static renderHoverableArea(
			...
			borderHoverColor: java.awt.Color,
		): void;
		 ...
		 * @param image The image to render.
		 */
		static renderImageLocation(graphics: Graphics2D, imgLoc: net.runelite.api.Point, image: BufferedImage): void;
		 ...
		 */
		static renderMinimapLocation(graphics: Graphics2D, mini: net.runelite.api.Point, color: java.awt.Color): void;
		 ...
		 */
		static renderPolygon(graphics: java.awt.Graphics2D, poly: Shape, color: java.awt.Color): void;
		 ...
		 * @param borderStroke The border stroke of the polygon.
		 */
		static renderPolygon(graphics: Graphics2D, poly: Shape, color: java.awt.Color, borderStroke: Stroke): void;
		 ...
		 */
		static transformPosition(position: any, dimension: java.awt.Dimension): net.runelite.api.Point;
	}
}
